...
public class FactionCommands {
	...
	public static void invite(CommandContext args, Saga plugin, SagaPlayer sagaPlayer) {
		...
		// Already in faction:
		if(invitedPlayer.getRegisteredFaction() != null){
	...
	public static void kick(CommandContext args, Saga plugin, SagaPlayer sagaPlayer) {
		...
		// Not faction member:
		if( !selectedFaction.equals(selectedPlayer.getRegisteredFaction()) ){
...
//	    	Saga.broadcast(FactionMessages.deleted(sagaPlayer, selectedFaction));
	...
	public static void setRank(CommandContext args, Saga plugin, SagaPlayer sagaPlayer) {
		...
		// Not faction member:
		if( !selectedFaction.equals(targetPlayer.getRegisteredFaction()) ){
...
//	    String oldPrefix = selectedFaction.getPrefix();
	...
	// Create message:
	String message = selectedFaction.getSecondaryColor() + "[" + selectedFaction.getPrimaryColor() + FactionMessages.rankedPlayer(sagaPlayer) + selectedFaction.getSecondaryColor() + "] " + args.getJoinedStrings(0);
	...
	public static void setPrimaryColor(CommandContext args, Saga plugin, SagaPlayer sagaPlayer) {
		...
		if(color == null){
			...
			sagaPlayer.message(FactionMessages.possibleColors(selectedFaction));
			return;
		}
	...
	public static void help(CommandContext args, Saga plugin, SagaPlayer sagaPlayer) {
		...
		// Inform:
		sagaPlayer.message(FactionMessages.help(page));
